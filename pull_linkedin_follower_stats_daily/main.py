...
def get_api_data():
    ...
    url = "https://api.linkedin.com/rest/organizationalEntityFollowerStatistics?q=organizationalEntity&organizationalEntity=urn:li:organization:30216658&timeIntervals.timeGranularityType=DAY&timeIntervals.timeRange.start={}&timeIntervals.timeRange.end={}".format(time_range_start, time_range_end)
...
def pull_to_prod():
    ...
    df = get_api_data()
    bq_load('linkedin_follower_stats_daily', df, 'cdb_marketing_data')
...
def pull_to_staging():
    ...
    schema = [
        bigquery.SchemaField("organic_follower_gain", "INTEGER", mode="REQUIRED"),
        bigquery.SchemaField("paid_follower_gain", "INTEGER", mode="REQUIRED"),
